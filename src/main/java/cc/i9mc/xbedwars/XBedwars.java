package cc.i9mc.xbedwars;

import cc.i9mc.gameutils.BukkitGameUtils;
import cc.i9mc.k8sgameack.K8SGameACK;
import cc.i9mc.k8sgameack.utils.IPUtil;
import cc.i9mc.xbedwars.commands.AdminCommand;
import cc.i9mc.xbedwars.commands.StartCommand;
...
import cc.i9mc.xbedwars.listeners.*;
...
@Getter
public final class XBedwars extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("isUP")) {
            ...
            K8SGameACK.getInstance().getServerData().setGameType("XBedWars");
            ...
            BukkitGameUtils.getInstance().getPubSubListener().addChannel("MINIGame.XBW." + IPUtil.getLocalIp());
    ...
    public int getLevel(int level) {
        int playerLevel = 0;
        for (Map.Entry<Integer, Integer> entry : XBedwars.playerLevel.entrySet()) {
